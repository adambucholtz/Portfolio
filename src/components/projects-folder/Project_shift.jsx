  ...
  return (
    <div id="Project_shift" className="w-screen bg-[#fffefb] text-[#1e1e1e] py-16 px-4 md:px-10 lg:px-16 space-y-10">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-5xl font-bold text-justify">The Shift</h2>
        <h2>School, Modular, Canopy, Overhangs</h2>
        ...
        <div className="space-y-16">
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center gap-10">
                <img src="/photos/SPRING SECOND YEAR - Shift/Shift-3.png" className="lg:w-1/2 w-full rounded-xl shadow-lg object-contain" alt="" />
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10">
                ...
                <img src="/photos/SPRING SECOND YEAR - Shift/Shift-8.png" className="lg:w-1/2 w-full rounded-xl shadow-lg object-contain" alt="" />
            </div>
        </div>
      </div>
    </div>
