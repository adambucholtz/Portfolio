    ...
    <section id="First_Project_oasis" className="w-screen bg-[#fdfaf5] text-[#1e1e1e] py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          <img
            src="/photos/2025S_ARC3021A_02_Lords_Bucholtz_Adam_M2_012.jpg"
            alt="Exterior View from Degnan Boulevard"
            className="rounded-lg shadow-md w-full object-cover"
          />
          <img
            src="/photos/2025S_ARC3021A_02_Lords_Bucholtz_Adam_M2_010.jpg"
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          <img
            src="/photos/2025S_ARC3021A_02_Lords_Bucholtz_Adam_M2_09.jpg"
            alt="Interior Circulation and Gallery"
            className="rounded-lg shadow-md w-full object-cover"
          />
          <img
            src="/photos/2025S_ARC3021A_02_Lords_Bucholtz_Adam_M2_011.jpg"
